...
} from "./chunk-KVXQIVKC.js";
import "./chunk-O6ZBSBYX.js";
import {
  EMPTY_OBJ,
  NO,
  NOOP,
    ...
    !function(t, e) {
      ...
      return function(t2) {
        ...
        return n.m = t2, n.c = e, n.d = function(t3, e2, o) {
          ...
          if (n.r(o), Object.defineProperty(o, "default", { enumerable: true, value: t3 }), 2 & e2 && "string" != typeof t3)
            for (var i in t3)
              n.d(o, i, function(e3) {
                return t3[e3];
              }.bind(null, i));
        ...
        "use strict";
        (function(t3) {
          var n2 = "object" == typeof t3 && t3 && t3.Object === Object && t3;
          e.a = n2;
        }).call(this, n(2));
      }, function(t2, e) {
        var n;
        ...
        }, a = n(1), u = "object" == typeof self && self && self.Object === Object && self, c = a.a || u || Function("return this")(), s = function() {
          return c.Date.now();
        }, l = /\s/;
        var d = function(t3) {
          for (var e2 = t3.length; e2-- && l.test(t3.charAt(e2)); )
            ;
          return e2;
        }, f = /^\s+/;
        var p = function(t3) {
          return t3 ? t3.slice(0, d(t3) + 1).replace(f, "") : t3;
        }, m = c.Symbol, v = Object.prototype, h = v.hasOwnProperty, b = v.toString, y = m ? m.toStringTag : void 0;
        var g = function(t3) {
          var e2 = h.call(t3, y), n2 = t3[y];
          try {
            t3[y] = void 0;
            var o2 = true;
          } catch (t4) {
          ...
          var i2 = b.call(t3);
          return o2 && (e2 ? t3[y] = n2 : delete t3[y]), i2;
        }, j = Object.prototype.toString;
        var O = function(t3) {
          return j.call(t3);
        }, w = m ? m.toStringTag : void 0;
        var E = function(t3) {
          return null == t3 ? void 0 === t3 ? "[object Undefined]" : "[object Null]" : w && w in Object(t3) ? g(t3) : O(t3);
        };
        var S = function(t3) {
          return null != t3 && "object" == typeof t3;
        };
        var x = function(t3) {
          return "symbol" == typeof t3 || S(t3) && "[object Symbol]" == E(t3);
        }, T = /^[-+]0x[0-9a-f]+$/i, V = /^0b[01]+$/i, D = /^0o[0-7]+$/i, N = parseInt;
        var $ = function(t3) {
          if ("number" == typeof t3)
            return t3;
          if (x(t3))
          ...
          t3 = p(t3);
          var n2 = V.test(t3);
          return n2 || D.test(t3) ? N(t3.slice(2), n2 ? 2 : 8) : T.test(t3) ? NaN : +t3;
        }, I = Math.max, M = Math.min;
        var C = function(t3, e2, n2) {
          var o2, i2, a2, u2, c2, l2, d2 = 0, f2 = false, p2 = false, m2 = true;
          if ("function" != typeof t3)
            throw new TypeError("Expected a function");
          function v2(e3) {
            var n3 = o2, r2 = i2;
            return o2 = i2 = void 0, d2 = e3, u2 = t3.apply(r2, n3);
          }
          function h2(t4) {
            return d2 = t4, c2 = setTimeout(y2, e2), f2 ? v2(t4) : u2;
          }
          function b2(t4) {
            var n3 = t4 - l2;
            return void 0 === l2 || n3 >= e2 || n3 < 0 || p2 && t4 - d2 >= a2;
          }
          function y2() {
            var t4 = s();
            if (b2(t4))
              return g2(t4);
            c2 = setTimeout(y2, function(t5) {
              var n3 = e2 - (t5 - l2);
              return p2 ? M(n3, a2 - (t5 - d2)) : n3;
            }(t4));
          }
          function g2(t4) {
            return c2 = void 0, m2 && o2 ? v2(t4) : (o2 = i2 = void 0, u2);
          }
          function j2() {
            var t4 = s(), n3 = b2(t4);
            if (o2 = arguments, i2 = this, l2 = t4, n3) {
              if (void 0 === c2)
                return h2(l2);
              if (p2)
                return clearTimeout(c2), c2 = setTimeout(y2, e2), v2(l2);
            }
            return void 0 === c2 && (c2 = setTimeout(y2, e2)), u2;
          }
          return e2 = $(e2) || 0, r(n2) && (f2 = !!n2.leading, a2 = (p2 = "maxWait" in n2) ? I($(n2.maxWait) || 0, e2) : a2, m2 = "trailing" in n2 ? !!n2.trailing : m2), j2.cancel = function() {
            void 0 !== c2 && clearTimeout(c2), d2 = 0, o2 = l2 = i2 = c2 = void 0;
          }, j2.flush = function() {
            return void 0 === c2 ? u2 : g2(s());
          }, j2;
        };
        var R = { name: "ckeditor", created() {
          const { CKEDITOR_VERSION: t3 } = window;
          if (t3) {
            const [e2] = t3.split(".").map(Number);
            e2 < 34 && console.warn("The <CKEditor> component requires using CKEditor 5 in version 34 or higher.");
          } else
            console.warn('Cannot find the "CKEDITOR_VERSION" in the "window" scope.');
        }, render() {
          return Object(o.h)(this.tagName);
        }, model: { prop: "modelValue", event: "update:modelValue" }, props: { editor: { type: Function, default: null }, modelValue: { type: String, default: "" }, config: { type: Object, default: () => ({}) }, tagName: { type: String, default: "div" }, disabled: { type: Boolean, default: false } }, data: () => ({ instance: null, lastEditorData: { type: String, default: "" } }), mounted() {
          const t3 = Object.assign({}, this.config);
          this.modelValue && (t3.initialData = this.modelValue), this.editor.create(this.$el, t3).then((e2) => {
            this.instance = Object(o.markRaw)(e2), this.setUpEditorEvents(), this.modelValue !== t3.initialData && e2.setData(this.modelValue), this.disabled && e2.enableReadOnlyMode("Integration Sample"), this.$emit("ready", e2);
          }).catch((t4) => {
            console.error(t4);
          });
        }, beforeUnmount() {
          ...
          this.instance && t3 !== this.lastEditorData && this.instance.setData(t3);
        }, disabled(t3) {
          ...
          const t3 = this.instance, e2 = C((e3) => {
            const n2 = this.lastEditorData = t3.getData();
        ...
        const _ = i.a ? i.a.version : o.version, [k] = _.split(".").map((t3) => parseInt(t3, 10));
        if (k < 3)
