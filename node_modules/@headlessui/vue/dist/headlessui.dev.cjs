...
var Combobox = (0, import_vue10.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    let optionsRef = (0, import_vue10.ref)(null);
    ...
    let activationTrigger = (0, import_vue10.ref)(1 /* Other */);
    ...
    let [value, theirOnChange] = useControllable((0, import_vue10.computed)(() => props.modelValue), (value2) => emit("update:modelValue", value2), (0, import_vue10.computed)(() => props.defaultValue));
    let api = {
      comboboxState,
      value,
      mode,
      ...
      openCombobox() {
        ...
        let optionIdx = options.value.findIndex((option) => {
          ...
          let selected = match(mode.value, {
            ...
            [1 /* Multi */]: () => (0, import_vue10.toRaw)(api.value.value).some((value2) => api.compare((0, import_vue10.toRaw)(value2), (0, import_vue10.toRaw)(optionValue)))
          });
          return selected;
        });
        if (optionIdx !== -1) {
    ...
    useOutsideClick([inputRef, buttonRef, optionsRef], () => api.closeCombobox(), (0, import_vue10.computed)(() => comboboxState.value === 0 /* Open */));
    (0, import_vue10.provide)(ComboboxContext, api);
    useOpenClosedProvider((0, import_vue10.computed)(() => match(comboboxState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    let activeOption = (0, import_vue10.computed)(() => api.activeOptionIndex.value === null ? null : options.value[api.activeOptionIndex.value].dataRef.value);
    return () => {
      ...
      return (0, import_vue10.h)(import_vue10.Fragment, [
        ...name != null && value.value != null ? objectToFormEntries({ [name]: value.value }).map(([name2, value2]) => {
          return (0, import_vue10.h)(Hidden, compact({
            features: 4 /* Hidden */,
            key: name2,
            as: "input",
            type: "hidden",
...
var ComboboxButton = (0, import_vue10.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue10.computed)(() => ({ as: props.as, type: attrs.type })), api.buttonRef);
    return () => {
      var _a, _b;
      let slot = {
        open: api.comboboxState.value === 0 /* Open */,
...
var ComboboxInput = (0, import_vue10.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let __fixVueImmediateWatchBug__ = (0, import_vue10.ref)("");
    ...
    (0, import_vue10.onMounted)(() => {
      (0, import_vue10.watch)([api.value, __fixVueImmediateWatchBug__], () => {
        currentValue.value = getCurrentValue();
      }, {
        flush: "sync",
        immediate: true
      });
      (0, import_vue10.watch)([currentValue, api.comboboxState], ([currentValue2, state], [oldCurrentValue, oldState]) => {
        let input = dom(api.inputRef);
        if (!input)
          return;
    ...
    let isComposing = (0, import_vue10.ref)(false);
...
var ComboboxOption = (0, import_vue10.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue10.computed)(() => match(api.mode.value, {
      [0 /* Single */]: () => api.compare((0, import_vue10.toRaw)(api.value.value), (0, import_vue10.toRaw)(props.value)),
      [1 /* Multi */]: () => (0, import_vue10.toRaw)(api.value.value).some((value) => api.compare((0, import_vue10.toRaw)(value), (0, import_vue10.toRaw)(props.value)))
    }));
...
var FocusTrap = Object.assign((0, import_vue14.defineComponent)({
  name: "FocusTrap",
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    useRestoreFocus({ ownerDocument }, (0, import_vue14.computed)(() => Boolean(props.features & 16 /* RestoreFocus */)));
    let previousActiveElement = useInitialFocus({ ownerDocument, container, initialFocus: (0, import_vue14.computed)(() => props.initialFocus) }, (0, import_vue14.computed)(() => Boolean(props.features & 2 /* InitialFocus */)));
    useFocusLock({
      ownerDocument,
      container,
...
function useRestoreFocus({ ownerDocument }, enabled) {
  ...
  (0, import_vue14.onMounted)(() => {
    (0, import_vue14.watch)(enabled, (newValue, prevValue) => {
...
function useInitialFocus({
  ...
  (0, import_vue14.onMounted)(() => {
    (0, import_vue14.watch)([container, initialFocus, enabled], (newValues, prevValues) => {
...
var Portal = (0, import_vue17.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    let myTarget = (0, import_vue17.ref)(forcePortalRoot === true ? getPortalRoot(element.value) : groupContext == null ? getPortalRoot(element.value) : groupContext.resolveTarget());
    ...
    return () => {
      ...
      return (0, import_vue17.h)(import_vue17.Teleport, { to: myTarget.value }, render({
        ourProps,
        theirProps: props,
        slot: {},
        attrs,
...
function useStackProvider({
  ...
  (0, import_vue18.onMounted)(() => {
    (0, import_vue18.watch)(enabled, (isEnabled, oldIsEnabled) => {
      if (isEnabled) {
...
function useDescriptions({
  ...
  return (0, import_vue19.computed)(() => descriptionIds.value.length > 0 ? descriptionIds.value.join(" ") : void 0);
}
...
var Dialog = (0, import_vue20.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let dialogState = (0, import_vue20.computed)(() => !ready.value ? 1 /* Closed */ : open.value ? 0 /* Open */ : 1 /* Closed */);
    ...
    useInertOthers(internalDialogRef, (0, import_vue20.computed)(() => hasNestedDialogs.value ? enabled.value : false));
    useStackProvider({
      type: "Dialog",
    ...
    }, (0, import_vue20.computed)(() => dialogState.value === 0 /* Open */ && !hasNestedDialogs.value));
    ...
    return () => {
      ...
      return (0, import_vue20.h)(ForcePortalRoot, { force: true }, () => [
        (0, import_vue20.h)(Portal, () => (0, import_vue20.h)(PortalGroup, { target: internalDialogRef.value }, () => (0, import_vue20.h)(ForcePortalRoot, { force: false }, () => (0, import_vue20.h)(FocusTrap, {
          initialFocus,
          containers,
...
var DialogBackdrop = (0, import_vue20.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      return (0, import_vue20.h)(ForcePortalRoot, { force: true }, () => (0, import_vue20.h)(Portal, () => render({
        ourProps,
        theirProps: { ...attrs, ...theirProps },
        slot: { open: api.dialogState.value === 0 /* Open */ },
        attrs,
...
var Disclosure = (0, import_vue21.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    let disclosureState = (0, import_vue21.ref)(props.defaultOpen ? 0 /* Open */ : 1 /* Closed */);
    ...
    useOpenClosedProvider((0, import_vue21.computed)(() => {
...
var DisclosureButton = (0, import_vue21.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue21.computed)(() => ({ as: props.as, type: attrs.type })), internalButtonRef);
    function handleClick() {
      var _a;
      if (props.disabled)
        return;
...
var Listbox = (0, import_vue22.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    let activationTrigger = (0, import_vue22.ref)(1 /* Other */);
    function adjustOrderedState(adjustment = (i) => i) {
      let currentActiveOption = activeOptionIndex.value !== null ? options.value[activeOptionIndex.value] : null;
      let sortedOptions = sortByDomNode(adjustment(options.value.slice()), (option) => dom(option.dataRef.domRef));
      let adjustedActiveOptionIndex = currentActiveOption ? sortedOptions.indexOf(currentActiveOption) : null;
    ...
    let [value, theirOnChange] = useControllable((0, import_vue22.computed)(() => props.modelValue), (value2) => emit("update:modelValue", value2), (0, import_vue22.computed)(() => props.defaultValue));
    let api = {
      listboxState,
      value,
      mode,
    ...
    useOpenClosedProvider((0, import_vue22.computed)(() => match(listboxState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    return () => {
      ...
      return (0, import_vue22.h)(import_vue22.Fragment, [
        ...name != null && value.value != null ? objectToFormEntries({ [name]: value.value }).map(([name2, value2]) => (0, import_vue22.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var ListboxButton = (0, import_vue22.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue22.computed)(() => ({ as: props.as, type: attrs.type })), api.buttonRef);
    return () => {
      var _a, _b;
      let slot = {
        open: api.listboxState.value === 0 /* Open */,
...
var ListboxOption = (0, import_vue22.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue22.computed)(() => match(api.mode.value, {
      [0 /* Single */]: () => api.compare((0, import_vue22.toRaw)(api.value.value), (0, import_vue22.toRaw)(props.value)),
      [1 /* Multi */]: () => (0, import_vue22.toRaw)(api.value.value).some((value) => api.compare((0, import_vue22.toRaw)(value), (0, import_vue22.toRaw)(props.value)))
    }));
    let isFirstSelected = (0, import_vue22.computed)(() => {
      return match(api.mode.value, {
        [1 /* Multi */]: () => {
          ...
          return ((_a = api.options.value.find((option) => currentValues.some((value) => api.compare((0, import_vue22.toRaw)(value), (0, import_vue22.toRaw)(option.dataRef.value))))) == null ? void 0 : _a.id) === id2;
        },
    ...
    (0, import_vue22.onMounted)(() => {
      (0, import_vue22.watch)([api.listboxState, selected], () => {
        if (api.listboxState.value !== 0 /* Open */)
          return;
        if (!selected.value)
          return;
...
var Menu = (0, import_vue23.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    let activationTrigger = (0, import_vue23.ref)(1 /* Other */);
    function adjustOrderedState(adjustment = (i) => i) {
    ...
    useOpenClosedProvider((0, import_vue23.computed)(() => match(menuState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    return () => {
...
var MenuButton = (0, import_vue23.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue23.computed)(() => ({ as: props.as, type: attrs.type })), api.buttonRef);
    return () => {
      var _a;
    ...
    function handleKeyDown(event) {
      ...
      switch (event.key) {
        ...
        case "Tab" /* Tab */:
          ...
          event.stopPropagation();
          api.closeMenu();
          (0, import_vue23.nextTick)(() => focusFrom(dom(api.buttonRef), event.shiftKey ? 2 /* Previous */ : 4 /* Next */));
          break;
        default:
          if (event.key.length === 1) {
            api.search(event.key);
...
var Popover = (0, import_vue24.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    useOpenClosedProvider((0, import_vue24.computed)(() => match(popoverState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    let registerBag = {
...
var PopoverButton = (0, import_vue24.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue24.computed)(() => ({ as: props.as, type: attrs.type })), elementRef);
    function handleKeyDown(event) {
      var _a, _b, _c, _d, _e;
      if (isWithinPanel) {
...
var Label = (0, import_vue25.defineComponent)({
  ...
  setup(myProps, { slots, attrs }) {
    ...
    return () => {
      ...
      let ourProps = {
        ...Object.entries(props).reduce((acc, [key, value]) => Object.assign(acc, { [key]: (0, import_vue25.unref)(value) }), {}),
        id: id2
      };
      if (passive) {
...
var RadioGroup = (0, import_vue26.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let [value, theirOnChange] = useControllable((0, import_vue26.computed)(() => props.modelValue), (value2) => emit("update:modelValue", value2), (0, import_vue26.computed)(() => props.defaultValue));
    let api = {
      options,
      value,
      disabled: (0, import_vue26.computed)(() => props.disabled),
      firstOption: (0, import_vue26.computed)(() => options.value.find((option) => {
        if (option.propsRef.disabled)
          return false;
        return true;
      })),
      containsCheckedOption: (0, import_vue26.computed)(() => options.value.some((option) => api.compare((0, import_vue26.toRaw)(option.propsRef.value), (0, import_vue26.toRaw)(props.modelValue)))),
      compare(a, z) {
        if (typeof props.by === "string") {
          let property = props.by;
          return (a == null ? void 0 : a[property]) === (z == null ? void 0 : z[property]);
      ...
      change(nextValue) {
        ...
        if (api.compare((0, import_vue26.toRaw)(value.value), (0, import_vue26.toRaw)(nextValue)))
          return false;
        let nextOption = (_a = options.value.find((option) => api.compare((0, import_vue26.toRaw)(option.propsRef.value), (0, import_vue26.toRaw)(nextValue)))) == null ? void 0 : _a.propsRef;
    ...
    return () => {
      ...
      return (0, import_vue26.h)(import_vue26.Fragment, [
        ...name != null && value.value != null ? objectToFormEntries({ [name]: value.value }).map(([name2, value2]) => (0, import_vue26.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var Switch = (0, import_vue27.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let [checked, theirOnChange] = useControllable((0, import_vue27.computed)(() => props.modelValue), (value) => emit("update:modelValue", value), (0, import_vue27.computed)(() => props.defaultChecked));
    function toggle() {
    ...
    let type = useResolveButtonType((0, import_vue27.computed)(() => ({ as: props.as, type: attrs.type })), switchRef);
    ...
    return () => {
      ...
      return (0, import_vue27.h)(import_vue27.Fragment, [
        name != null && checked.value != null ? (0, import_vue27.h)(Hidden, compact({
          features: 4 /* Hidden */,
          as: "input",
          type: "checkbox",
          hidden: true,
...
var TabGroup = (0, import_vue29.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    let realSelectedIndex = (0, import_vue29.computed)(() => isControlled.value ? props.selectedIndex : selectedIndex.value);
    let api = {
      selectedIndex,
...
var Tab = (0, import_vue29.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue29.computed)(() => ({ as: props.as, type: attrs.type })), internalTabRef);
    return () => {
      var _a;
...
var TransitionChild = (0, import_vue30.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    if (!hasTransitionContext() && hasOpenClosed()) {
      return () => (0, import_vue30.h)(TransitionRoot, {
        ...props,
    ...
    (0, import_vue30.onMounted)(() => {
      (0, import_vue30.watch)([show], (_oldValues, _newValues, onInvalidate) => {
        executeTransition(onInvalidate);
        initial.value = false;
      }, { immediate: true });
    });
    (0, import_vue30.provide)(NestingContext, nesting);
    useOpenClosedProvider((0, import_vue30.computed)(() => match(state.value, {
    ...
    return () => {
      ...
      return render({
        ...
        slots: {
          ...slots,
          default: () => [
            (0, import_vue30.h)(_TransitionChild, {
              onBeforeEnter: () => emit("beforeEnter"),
              onAfterEnter: () => emit("afterEnter"),
              onBeforeLeave: () => emit("beforeLeave"),
              onAfterLeave: () => emit("afterLeave"),
