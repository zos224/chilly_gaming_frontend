<template>
    <!-- component -->
<div style="height: auto; min-height: 100%;" class="w-full left-0 h-full top-0 absolute bg-slate-300">
    <dh-component>
        <div class="flex h-full flex-no-wrap">
            <div class="w-64 sm:relative bg-gray-800 shadow h-full flex-col justify-between hidden sm:flex">
                <div class="px-8">
                    <div class="h-16 mt-4 w-full flex items-center">
                        <img src="../../../public/logo_text_ngang.png" alt="">
                    </div>
                    <ul class="mt-12">
                        <li @click="router.push({name: 'AdminDashboard'})" class="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">TRANG CHỦ</span>
                            </a>
                        </li>
                        <li @click="router.push({name: 'AdminGames'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">QUẢN LÝ GAMES</span>
                            </a>
                        </li>
                        <li @click="router.push({name: 'AdminTheloai'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">QUẢN LÝ THỂ LOẠI GAME</span>
                            </a>
                        </li>
                        <li @click="router.push({name: 'AdminUser'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                                ...
                                <span class="text-sm ml-2">QUẢN LÝ NGƯỜI DÙNG</span>
                            </a>
                        </li>
                        <li @click="router.push({name: 'AdminReport'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                                </svg>
                                <span class="text-sm ml-2">QUẢN LÝ BÁO CÁO</span>
                            </a>
                            <div v-if="report > 0" class="py-1 px-3 bg-rose-600 rounded-full font-semibold text-gray-300 flex items-center justify-center text-xs">{{ report }}</div>
                        </li>
                        <li @click="router.push({name: 'AdminArticle'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">QUẢN LÝ TIN TỨC</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
                ...
                <button aria-label="Close sidebar" id="closeSideBar" class="flex h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" @click="sidebarHandler(false)">
                ...
                <div class="px-8">
                    ...
                    <ul class="mt-12">
                        <li @click="router.push({name: 'AdminDashboard'})" class="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-grid" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                    <rect x="4" y="4" width="6" height="6" rx="1"></rect>
                        ...
                        <li @click="router.push({name: 'AdminReport'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            ...
                            <div v-if="report > 0" class="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">{{ report }}</div>
                        </li>
                        <li @click="router.push({name: 'AdminArticle'})" class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-stack" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
import store from '../../store';
    ...
    let report = computed(() => store.state.noProcessReport);
